...
var config = {
    ...
    generateMainPage: function (year) { return (year == new Date().getFullYear() ? config.mainPage : config.mainBaseURL + year.toString() + ".htm"); },
    pressAPIBasePage: "https://www.mod.go.jp/js/tpl/Press/",
    generateAPIRequest: function (year, month) { return config.pressAPIBasePage + year +
        "/" + year +
